...
requests1 = requests.get("https://www.amazon.in/Apple-MacBook-Chip-13-inch-256GB/dp/B08N5W4NNB/ref=sr_1_1?crid=1J2JI0HJBX9JV&keywords=macbook+air+m1&qid=1680253105&sprefix=macbook+air+m%2Caps%2C229&sr=8-1")
...
reviews = soup.find_all( 'div' , { 'class' : 'a-expander-content reviewText review-text-content a-expander-partial-collapse-content'}); # or findAll
print(reviews)
